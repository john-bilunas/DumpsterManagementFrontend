  ...
  return (
    <div className="individual-inventory-and-pricing-containers surface">
      ...
      <div className="form-container">
        <AddDumpster
          onAddDumpster={onAddDumpster}
          addDumpstersErrorMessage={addDumpstersErrorMessage}
        />
        {addDumpstersErrorMessage.length !== 0 ? (
          <p className="error center">{addDumpstersErrorMessage}</p>
        ) : (
          <></>
        )}
      </div>
